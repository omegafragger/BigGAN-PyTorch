...
--ensemble_path /data/coml-ecr/shug5721/ensemble/ --lamda1 1.0 --lamda2 1.5 \
--weights_root /data/coml-ecr/shug5721/biggan_models/biggan_cifar_1.5/weights \
--samples_root /data/coml-ecr/shug5721/biggan_models/biggan_cifar_1.5/samples