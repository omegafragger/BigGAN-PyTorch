...
--ensemble_path /data/coml-ecr/shug5721/ensemble/ --lamda1 1.0 --lamda2 0.75 \
--weights_root /data/coml-ecr/shug5721/biggan_models/biggan_cifar_0.75/weights \
--samples_root /data/coml-ecr/shug5721/biggan_models/biggan_cifar_0.75/samples